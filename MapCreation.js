...
const STATICOBJECTS = [
    ...
    new Cloud(132, 11, 3),
    new Bush(137, 2, 4),
    new HardBlock(134, 2, 3, 1),
    new HardBlock(135, 3, 2, 1),
    new HardBlock(136, 4, 1, 1),
    new HardBlock(137, 2, 1, 4),

    new HardBlock(140, 2, 1, 4),
    new HardBlock(141, 4, 1, 1),
    new HardBlock(141, 3, 2, 1),
    new HardBlock(141, 2, 3, 1),
    new BackgroundHill(146, 5, 3),
    new HardBlock(148, 2, 4, 1),
    new HardBlock(149, 3, 3, 1),
    new HardBlock(150, 4, 2, 1),
    new HardBlock(151, 5, 1, 1),
    new HardBlock(152, 2, 1, 4),
    new Bush(158, 2, 2),
...
const MOBILEOBJECTS = [
    ...
    new Goomba(45, 2, {right: true}),
    new Goomba(81,10, {left: true}),
    new Goomba(84,10, {left: true}),
    new Goomba(93, 2, {left: true}),
    new Goomba(96, 2, {left: true}),
    new Turtle(102, 2, {left: true}),
    new Goomba(110, 2, {left: true}),
    new Goomba(113, 2, {left: true}),
    new Goomba(116, 2, {left: true}),
    new Goomba(120, 2, {left: true}),
    new Goomba(123, 2, {left: true}),
    new Goomba(126, 2, {left: true}),
